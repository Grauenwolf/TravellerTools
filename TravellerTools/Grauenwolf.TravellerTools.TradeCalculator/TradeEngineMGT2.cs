...
public class TradeEngineMgt2(TravellerMapService mapService, string dataPath, NameGenerator nameGenerator, Characters.CharacterBuilder characterBuilder) : TradeEngine(mapService, dataPath, nameGenerator, characterBuilder)
{
