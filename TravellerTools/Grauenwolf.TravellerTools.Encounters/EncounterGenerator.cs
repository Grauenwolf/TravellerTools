...
public class EncounterGenerator(CharacterBuilder characterBuilder)
{
    ...
    public static Encounter PickMission(Dice dice, Encounter? encounter = null)
    {
        if (dice == null)
            throw new ArgumentNullException(nameof(dice), $"{nameof(dice)} is null.");
        ...
        switch (dice.D66())
        {
            case 11: encounter.Add("Assassinate a ", PickTarget(dice)); break;
            case 12: encounter.Add("Frame a ", PickTarget(dice)); break;
            case 13: encounter.Add("Destroy a ", PickTarget(dice)); break;
            case 14: encounter.Add("Steal from a ", PickTarget(dice)); break;
            ...
            case 22: encounter.Add("Discredit a ", PickTarget(dice)); break;
            case 23: encounter.Add("Find a lost cargo"); break;
            case 24: encounter.Add("Find a lost person"); break;
            case 25: encounter.Add("Deceive a ", PickTarget(dice)); break;
            case 26: encounter.Add("Sabotage a ", PickTarget(dice)); break;
            case 31: encounter.Add("Transport goods"); break;
            case 32: encounter.Add("Transport a person"); break;
            case 33: encounter.Add("Transport data"); break;
            case 34: encounter.Add("Transport goods secretly"); break;
            case 35: encounter.Add("Transport goods quickly"); break;
            ...
            case 45: encounter.Add("Investigate a ", PickTarget(dice)); break;
            ...
            case 63: encounter.Add("Protect a ", PickTarget(dice)); break;
            case 64: encounter.Add("Save a ", PickTarget(dice)); break;
            case 65: encounter.Add("Aid a ", PickTarget(dice)); break;
            case 66: encounter.Add("It is a trap – the Patron intends to betray the Traveller. Fake mission: ", PickMission(dice)); break;
        }
        return encounter;
    }

    public static Encounter PickPatron(Dice dice, Encounter? encounter = null)
    {
        if (dice == null)
            throw new ArgumentNullException(nameof(dice), $"{nameof(dice)} is null.");
    ...
    public static Encounter PickTarget(Dice dice)
    {
        if (dice == null)
            throw new ArgumentNullException(nameof(dice), $"{nameof(dice)} is null.");
        ...
        switch (dice.D66())
        {
            case 11: result.Add("Common Trade Goods"); break;
            case 12: result.Add("Common Trade Goods"); break;
            case 13: result.Add("Random Trade Goods"); break;
            case 14: result.Add("Random Trade Goods"); break;
            case 15: result.Add("Illegal Trade Goods"); break;
            case 16: result.Add("Illegal Trade Goods"); break;
            ...
            case 51: return new("Local Government");
            case 52: return new("Planetary Government");
            case 53: return new("Corporation");
            case 54: return new("Imperial Intelligence");
            case 55: return new("Criminal Syndicate");
            case 56: return new("Criminal Gang");
            case 61: return new("Free Trader");
            case 62: return new("Yacht");
            case 63: return new("Cargo Hauler");
            case 64: return new("Police Cutter");
            case 65: return new("Space Station");
            case 66: return new("Warship");
        }
        return new("ERROR");
    }
