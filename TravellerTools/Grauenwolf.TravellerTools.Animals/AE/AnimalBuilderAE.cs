...
public static class AnimalBuilderAE
{
    ...
    static public ImmutableList<AnimalClassTemplate> AnimalClassList => ImmutableList.Create(s_Templates.AnimalClasses);

    static public ImmutableList<Behavior> BehaviorList => ImmutableList.Create(s_Templates.Behaviors);

    static public ImmutableList<TerrainTemplate> TerrainTypeList => ImmutableList.Create(s_Templates.Terrains);
