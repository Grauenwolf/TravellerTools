...
public abstract class FullCareer(string name, string? assignment, SpeciesCharacterBuilder speciesCharacterBuilder) : CareerBase(name, assignment, speciesCharacterBuilder)
{
