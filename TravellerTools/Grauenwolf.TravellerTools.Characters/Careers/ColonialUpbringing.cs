...
namespace Grauenwolf.TravellerTools.Characters.Careers
{
    class ColonialUpbringing(Book book) : CareerBase("Colonial Upbringing", null, book)
    {
        ...
        {
            character.AddHistory($"Entered Colonial Upbringing at age {character.Age}");
            ...
            if (graduation < 8)
            {
                character.AddHistory($"Failed as a colonist age {character.Age}.");
            ...
            else
            {
                ...
                if (graduation >= 12)
                {
                    character.AddHistory($"Left the colonies with honors at age {character.Age}.");
                ...
                else
                {
                    ...
                    character.AddHistory($"Left the colonies at age {character.Age}.");
                }
