...
public class CareerHistory(int firstTermAge, string career, string? assignment, CareerTypes careerTypes, int rank, int commissionRank = 0)
{
    public string? Assignment { get; } = assignment;
    public string Career { get; } = career;
    public CareerTypes CareerTypes { get; } = careerTypes;
